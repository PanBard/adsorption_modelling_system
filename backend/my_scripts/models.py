class PredictionClass:
    ...
    dev_jupyter_flag = False # to change input processing, becouse in flask we get request object and i dont have this object in jupyter
...
# }
    ...
    def get_similar_article(self, siotherm_input, material_type):
        ...
        # print(f"similarity_np_array {similarity_np_array[:3]}")
